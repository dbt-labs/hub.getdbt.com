...
function getHydrationData({
  ...
  let initialMatches = _chunkLKUVSIBAjs.matchRoutes.call(void 0, routes, location, basename);
  if (initialMatches) {
...
function RSCDefaultRootErrorBoundaryImpl({
  ...
  if (_chunkLKUVSIBAjs.isRouteErrorResponse.call(void 0, error)) {
    return /* @__PURE__ */ _react2.default.createElement(
      ...
      _chunkLKUVSIBAjs.ENABLE_DEV_WARNINGS ? heyDeveloper : null
    );
  }
  let errorInstance;
...
function RSCDefaultRootErrorBoundary({
  ...
  let error = _chunkLKUVSIBAjs.useRouteError.call(void 0, );
